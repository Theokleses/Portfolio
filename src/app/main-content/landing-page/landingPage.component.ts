    ...
    <section>
      <div class="first-sektion">
        <div class="img-container">
          <img class="landingpage-img" src="./assets/img/landingpage-image4.png"/>
        ...
        <div class="text-container">
          ...
          <div class="center-button">
            <a (click)="navigateTo('#my-contact')">
              <button class="button">
                {{ 'landing-page.button' | translate }}
              </button>
            </a>
          </div>
        </div>
      ...
      <div class="first-kontakt" [style.margin-top]="getDynamicMargin()">
        <div class="left-sektion">
          ...
          <a
            class="icons"
            href="https://github.com/Theokleses"
            target="_blank"
          ...
          <a
            class="icons"
            href="mailto:kontakt@osahonschmolze.com"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            class="icons"
            href="https://www.linkedin.com/in/osahon-schmolze-0b51181a2/"
            target="_blank"
            rel="noopener noreferrer"
            ><img src="./assets/img/linked.png"
          /></a>
          <p>
            <a class="mail" href="mailto:kontakt@osahonschmolze.com"
              >kontakt&#64;osahonschmolze.com
            </a>
          </p>
        </div>
